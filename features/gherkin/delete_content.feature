Feature: Delete content
  ...
  Scenario: Lecturer wants to delete an existing content with name "ContentX" in an existing chapter with title "ChapterX" for an existing course with title "CourseX"
