Feature: Create tag
  ...
  Scenario: Lecturer wants to add a new tag to an existing content with name "ContentX" in an existing chapter with title "ChapterX" for an existing course with title "CourseX"
  ...
  Scenario: Lecturer wants to add an already existing tag to an existing content with name "ContentX" in an existing chapter with title "ChapterX" for an existing course with title "CourseX"
    Given lecturer is logged in
    And a course exists with title "CourseX"
    And a chapter exists with title "ChapterX" for course with title "CourseX"
    And a content exists with name "ContentX" for chapter with title "ChapterX"
